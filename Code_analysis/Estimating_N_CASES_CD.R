...
diags_CD <- dbReadTable(conn = conn_inci, name = "diags_CD")
...
N <- N %>% 
  ...
  dplyr::select(CD, N_edu, PY_edu, CASES_edu, FEMALE_edu_N, FEMALE_edu_PY, FEMALE_edu_cases, 
...
dbWriteTable(conn_inci, "N_CASES_CD", N, overwrite = TRUE)
