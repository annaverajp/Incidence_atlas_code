...
# communicable diseases. CDs are defined according to GBD.                   #
##############################################################################
...
diags_CD_GBD <- dbReadTable(conn = conn_inci, name = "diags_CD_GBD")
...
dbWriteTable(conn_inci, "ASIR_CD_GBD", ASIR_CD, overwrite = TRUE)
